    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mainview" >
                ...
                <h3 style="text-align: center">Case id :${case_id}</h3>
                <h1 style="text-align: center">Criminal Information</h1>
                <form class="form-horizontal" role="form" modelAttribute="Criminal" action="insert_criminal?case_id=${case_id}" method="POST">
                    <div class="form-group">

                        <div class="col-md-8" >
                            <div class="inp" style="margin-left: 150px">

                                <label class="col-md-2 control-label">Criminal Name :</label>
                                ...
                                <input class="form-control" id="focusedInput" type="text" name="father" required ><br>

                                <label class="col-md-2 control-label">Contact no :</label>
                                <input class="form-control" id="focusedInput" type="number" name="contact" required ><br>

                                <label class="col-md-2 control-label">Address :</label>
                                <input class="form-control" id="focusedInput" type="text" name="address" required ><br>
                                ...
                                <br>
                                <input style="width: 200px;margin-left: 200px" class="btn btn-success" type="submit" value="Insert"/>
                            </div>
