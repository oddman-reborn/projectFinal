...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mainview" >
                        <h1 style="text-align: center">Search for Criminal History</h1>
                        
                        <br><br>
                        <form class="form-horizontal" role="form" action="searchCriminal" method="POST">
                ...
                <h3>Custom Search</h3>
                <form class="form-horizontal" role="form" action="customSearchCriminal" method="POST">
                            <div class="form-group">
