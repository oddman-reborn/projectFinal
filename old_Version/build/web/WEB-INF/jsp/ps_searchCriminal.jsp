    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mainview" >
                ...
                <form class="form-horizontal" role="form" action="ps_searchCriminal" method="POST">
                ...
                <h3>Custom Search</h3>
                <form class="form-horizontal" role="form" action="ps_CustomsearchCriminal" method="POST">
                            <div class="form-group">
