    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mainview" >
                ...
                <form class="form-horizontal" modelAttribute="Notification" role="form" action="insert_notification" method="POST">
                    <div class="form-group">

                        <div class="col-md-8" >
                            <div class="inp" style="margin-left: 150px">
                                <label class="col-md-2 control-label">Case ID :</label>
                                <input class="form-control" id="focusedInput" type="number" name="caseId" required ><br>

                                <label class="col-md-2 control-label">Message :</label>
                                <textarea class="form-control" id="focusedInput" type="text" name="message" style="height: 130px;width: 400px" textarea></textarea><br>
                                ...
                                <input class="form-control" id="focusedInput" type="text" name="generator" value="<%= user.getPsName() %>" required><br>

                                <input style="width: 200px;margin-left: 200px" class="btn btn-success" type="submit" value="Notify"/>
                            </div>
